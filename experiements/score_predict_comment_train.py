...
"""
Train a model to predict the score of an essay by the comment given
1. Construct the bag of words from the comments
2. Construct the word vectors from the comments
